...
bool OBSBasic::LoadService()
{
	...
	obs_data_set_default_string(data, "type", "dacast_rtmp");
...
bool OBSBasic::InitService()
{
	...
	service = obs_service_create("dacast_rtmp", "default_service", nullptr,
			nullptr);
	if (!service)
		return false;
	obs_service_release(service);
...
{
	if (!service) {
		service = obs_service_create("dacast_rtmp", NULL, NULL,
				nullptr);
		obs_service_release(service);
	}
	return service;
